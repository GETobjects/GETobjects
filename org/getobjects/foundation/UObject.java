...
public class UObject extends NSObject {
  ...
  /**
   * Same like extractString, only that the value does not have to be a string.
   * What it does:
   * <ul>
   ...
   * <li>if the object is a Collection or an Iterator, it returns the first item
   * returned by the iterator or null if there is none
   * <li>on String[] arrays, it returns the first item or null
  ...
  public static boolean isDiscreteNumber(final Object v) {
    ...
    if (v instanceof Integer || v instanceof Long || v instanceof BigInteger
    ...
    try {
      ...
      if (m != null) {
        ...
        if (v == null)
          return null;
        if (v != _v)
          return UObject.dateValue(v, _style, _locale);

...
public interface IGoObject {
  ...
  public static class Utility {
    ...
    public static Object lookupName
      (final Object _self, final String _name, final IGoContext _ctx, final boolean _acquire)
    {
      if (_self == null)
        return null;
     ...
     */
    public static GoClass goClass(final Object _self, final IGoContext _ctx) {

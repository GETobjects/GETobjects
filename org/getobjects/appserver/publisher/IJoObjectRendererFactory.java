 ...
 * <p>
 * Instances returned be the factory should be IJoObjectRenderer objects.
 * <p>
 * Unlike IJoObjectRenderer objects IJoObjectRendererFactory objects are
 ...
 * @see WOApplication  
 */
public interface IJoObjectRendererFactory {
  ...
  public class Utility {
    ...
    public static Object rendererForObjectInContext(Object _o, WOContext _ctx) {
      ...
      JoTraversalPath path = _ctx.joTraversalPath();
      if (path == null) {
        if (isInfoOn)
      ...
      for (int i = len - 1; i >= 0; i--) {
        ...
        if (objPath[i] instanceof IJoObjectRendererFactory) {
          Object renderer = ((IJoObjectRendererFactory)objPath[i])

 ...
 */
public class JoClass extends NSObject implements IJoObject {
  ...
  protected JoSecurityInfo securityInfo; 
  
  public JoClass(String _n, JoClass _superClass, Map<String, Object> _slots) {
    this.name         = _n;
    this.joSuperClass = _superClass;
    this.securityInfo = new JoSecurityInfo();
  ...
  public JoSecurityInfo securityInfo() {
    return this.securityInfo;
  }
  
  /* lookup names for objects of this class */
  
  public Object lookupName(Object _object, String _name, IJoContext _ctx) {
    ...
    if (this.slotNames != null) {
      for (int i = 0; i < this.slotNames.length; i++) {
        if (_name.equals(this.slotNames[i])) {
           ...
           */
          if (value instanceof IJoClassValueFactory) {
            IJoClassValueFactory factory = ((IJoClassValueFactory)value);
  ...
  public void appendAttributesToDescription(final StringBuilder _d) {
    ...
    if (this.joSuperClass != null) {
      ...
      for (JoClass c = this.joSuperClass(); c != null; c = c.joSuperClass()) {

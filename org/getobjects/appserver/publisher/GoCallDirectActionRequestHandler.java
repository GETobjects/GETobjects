 ...
 */
public class GoCallDirectActionRequestHandler
  extends WODirectActionRequestHandler
{

  public GoCallDirectActionRequestHandler(final WOApplication _app) {
    super(_app);
  }
  ...
  public Object lookupName(String _name, IGoContext _ctx, boolean _aquire) {
    ...
    IGoObject daRoot = (IGoObject)((OFSApplication)wctx.application())

 ...
 */
public class HelloThumbnail extends WOApplication {
  
  @Override
  public WOResponse handleSessionRestorationError(WOContext _ctx) {
    /* Otherwise we get a sn-fail exception in the output, we just redirect
     * to the app entry (aka Main page).
     */
  ...
  public static void main(String[] args) {
    new WOJettyRunner(HelloThumbnail.class, args).run();
  }
}
